...
(function() {
  ...
  app.AccountGroup = Backbone.Model.extend({
    idAttribute: '_id',
    url: function() {
      return '/admin/account-groups/'+ this.id +'/';
    }
  });
  ...
  app.Permissions = Backbone.Model.extend({
    ...
    url: function() {
      return '/admin/account-groups/'+ app.mainView.model.id +'/permissions/';
    },
    parse: function(response) {
      if (response.accountGroup) {
        app.mainView.model.set(response.accountGroup);
      ...
      if (confirm('Are you sure?')) {
        this.model.destroy({
          success: function(model, response) {
            if (response.success) {
              location.href = '/admin/account-groups/';
            }
            else {
