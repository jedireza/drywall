...
exports.find = function(req, res, next){
  ...
  req.app.db.models.AdminGroup.pagedFind({
    ...
    if (req.xhr) {
      ...
      results.filters = req.query;
      res.render('admin/admin-groups/index.jade', { data: { results: escape(JSON.stringify(results)) } });
    }
  });
};
...
exports.read = function(req, res, next){
  req.app.db.models.AdminGroup.findById(req.params.id).exec(function(err, adminGroup) {
    ...
    if (req.xhr) {
      ...
      res.render('admin/admin-groups/details.jade', { data: { record: escape(JSON.stringify(adminGroup)) } });
    }
  });
};
